...
def generate_datafile_from_pt(data_dir, fout, num_class=21, test_ratio=0.2, seed=1, start_idx=1):
    ...
    names = copy.deepcopy(object_names)
    ...
    for obj_name in names:
        for sample_num in range(start_idx, num_sample+start_idx):            
...
data_dir = "/home/ruihan/Joint-classifier/slide_6_10/"
fout = "slide.pkl"
generate_datafile_from_pt(data_dir=data_dir, fout=fout, num_class=23, start_idx=0)
# check the data file
